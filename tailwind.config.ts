  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "letter-reveal": { "0%": { opacity: "0", transform: "translateY(40px) rotateX(-90deg)" }, "100%": { opacity: "1", transform: "translateY(0) rotateX(0)" } },
        float: { "0%,100%": { transform: "translateY(0)" }, "50%": { transform: "translateY(-10px)" } },
        "glow-pulse": { "0%,100%": { boxShadow: "0 0 30px hsl(178 36% 55% / 0.4)" }, "50%": { boxShadow: "0 0 60px hsl(178 36% 55% / 0.7)" } },
      ...
      animation: {
        ...
        "letter-reveal": "letter-reveal 0.8s cubic-bezier(0.34,1.56,0.64,1) both",
